        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                    <li>
                        <x-admin.admin-sidelink href="/admin/students" :active="request()->is('admin-student')">Student</x-admin.admin-sidelink>
                    </li>
                    <li>
                        <x-admin.admin-sidelink href="/admin/grades" :active="request()->is('admin-grade')">Grade</x-admin.admin-sidelink>
                    </li>
                    <li>
                        <x-admin.admin-sidelink href="/admin/departments" :active="request()->is('admin-department')">Department</x-admin.admin-sidelink>
                    </li>
                </ul>
            </li>
            <li>
